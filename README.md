...
[Monet](https://github.com/ramLlama/monet) users get automatic diff-review awareness. When Claude Code requests a diff review, baton marks the session as waiting with reason "diff review" and resets it when you accept or quit. No configuration needed — `baton-mode` sets this up automatically when monet is loaded.
